...
#
# Generated by Vivado on Sun Mar 19 09:55:20 MDT 2017
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: xc7z020.sh [-help]
# usage: xc7z020.sh [-lib_map_path]
# usage: xc7z020.sh [-noclean_files]
# usage: xc7z020.sh [-reset_run]
#
...
# executing this script. Please type 'xc7z020.sh -help' for more information.
#
...
vhdlan_opts="-full64"
vcs_elab_opts="-load "/home/Xilinx/Vivado/2016.2/lib/lnx64.o/libxil_vcs.so:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"
...
# Script info
echo -e "xc7z020.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/xc7z020/ip/xc7z020_processing_system7_0_1/sim/xc7z020_processing_system7_0_1.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/xc7z020/ip/xc7z020_rst_processing_system7_0_100M_2/sim/xc7z020_rst_processing_system7_0_100M_2.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/xc7z020/hdl/xc7z020.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_longdiv_zero.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_add_tempA.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_PERIPH_BUS_s_axi.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_longdiv_one.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_mul_1.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_add.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_modexp.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_mul.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_longdiv.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_compare_state.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_copy.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_leftshift.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_sub.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_add_1.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_compare.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_zero.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_modexp_temp2.v" \
    "$ref_dir/../../../ipstatic/bigint_math_v1_0/hdl/verilog/bigint_math_bigint_rightshift.v" \
    "$ref_dir/../../../bd/xc7z020/ip/xc7z020_bigint_math_0_0/sim/xc7z020_bigint_math_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/xc7z020/ip/xc7z020_auto_pc_0/sim/xc7z020_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xc7z020 xil_defaultlib.glbl -o xc7z020_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xc7z020_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xc7z020.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key xc7z020_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc xc7z020_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xc7z020.sh -help\" for more information)\n"
    exit 1
  fi
