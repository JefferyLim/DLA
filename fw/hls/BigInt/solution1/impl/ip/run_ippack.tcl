...
set Interfaces {
    s_axi_PERIPH_BUS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x180 output_V_1 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 31 to 0 Data signal of output_V"}}} {0x184 output_V_2 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 63 to 32 Data signal of output_V"}}} {0x188 output_V_3 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 95 to 64 Data signal of output_V"}}} {0x18c output_V_4 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 127 to 96 Data signal of output_V"}}} {0x190 output_V_5 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 159 to 128 Data signal of output_V"}}} {0x194 output_V_6 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 191 to 160 Data signal of output_V"}}} {0x198 output_V_7 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 223 to 192 Data signal of output_V"}}} {0x19c output_V_8 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 255 to 224 Data signal of output_V"}}} {0x1a0 output_V_9 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 287 to 256 Data signal of output_V"}}} {0x1a4 output_V_10 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 319 to 288 Data signal of output_V"}}} {0x1a8 output_V_11 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 351 to 320 Data signal of output_V"}}} {0x1ac output_V_12 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 383 to 352 Data signal of output_V"}}} {0x1b0 output_V_13 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 415 to 384 Data signal of output_V"}}} {0x1b4 output_V_14 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 447 to 416 Data signal of output_V"}}} {0x1b8 output_V_15 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 479 to 448 Data signal of output_V"}}} {0x1bc output_V_16 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 511 to 480 Data signal of output_V"}}} {0x1c0 output_V_17 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 543 to 512 Data signal of output_V"}}} {0x1c4 output_V_18 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 575 to 544 Data signal of output_V"}}} {0x1c8 output_V_19 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 607 to 576 Data signal of output_V"}}} {0x1cc output_V_20 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 639 to 608 Data signal of output_V"}}} {0x1d0 output_V_21 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 671 to 640 Data signal of output_V"}}} {0x1d4 output_V_22 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 703 to 672 Data signal of output_V"}}} {0x1d8 output_V_23 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 735 to 704 Data signal of output_V"}}} {0x1dc output_V_24 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 767 to 736 Data signal of output_V"}}} {0x1e0 output_V_25 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 799 to 768 Data signal of output_V"}}} {0x1e4 output_V_26 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 831 to 800 Data signal of output_V"}}} {0x1e8 output_V_27 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 863 to 832 Data signal of output_V"}}} {0x1ec output_V_28 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 895 to 864 Data signal of output_V"}}} {0x1f0 output_V_29 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 927 to 896 Data signal of output_V"}}} {0x1f4 output_V_30 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 959 to 928 Data signal of output_V"}}} {0x1f8 output_V_31 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 991 to 960 Data signal of output_V"}}} {0x1fc output_V_32 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1023 to 992 Data signal of output_V"}}} {0x200 output_V_33 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1055 to 1024 Data signal of output_V"}}} {0x204 output_V_34 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1087 to 1056 Data signal of output_V"}}} {0x208 output_V_35 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1119 to 1088 Data signal of output_V"}}} {0x20c output_V_36 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1151 to 1120 Data signal of output_V"}}} {0x210 output_V_37 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1183 to 1152 Data signal of output_V"}}} {0x214 output_V_38 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1215 to 1184 Data signal of output_V"}}} {0x218 output_V_39 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1247 to 1216 Data signal of output_V"}}} {0x21c output_V_40 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1279 to 1248 Data signal of output_V"}}} {0x220 output_V_41 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1311 to 1280 Data signal of output_V"}}} {0x224 output_V_42 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1343 to 1312 Data signal of output_V"}}} {0x228 output_V_43 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1375 to 1344 Data signal of output_V"}}} {0x22c output_V_44 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1407 to 1376 Data signal of output_V"}}} {0x230 output_V_45 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1439 to 1408 Data signal of output_V"}}} {0x234 output_V_46 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1471 to 1440 Data signal of output_V"}}} {0x238 output_V_47 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1503 to 1472 Data signal of output_V"}}} {0x23c output_V_48 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1535 to 1504 Data signal of output_V"}}} {0x240 output_V_49 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1567 to 1536 Data signal of output_V"}}} {0x244 output_V_50 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1599 to 1568 Data signal of output_V"}}} {0x248 output_V_51 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1631 to 1600 Data signal of output_V"}}} {0x24c output_V_52 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1663 to 1632 Data signal of output_V"}}} {0x250 output_V_53 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1695 to 1664 Data signal of output_V"}}} {0x254 output_V_54 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1727 to 1696 Data signal of output_V"}}} {0x258 output_V_55 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1759 to 1728 Data signal of output_V"}}} {0x25c output_V_56 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1791 to 1760 Data signal of output_V"}}} {0x260 output_V_57 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1823 to 1792 Data signal of output_V"}}} {0x264 output_V_58 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1855 to 1824 Data signal of output_V"}}} {0x268 output_V_59 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1887 to 1856 Data signal of output_V"}}} {0x26c output_V_60 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1919 to 1888 Data signal of output_V"}}} {0x270 output_V_61 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1951 to 1920 Data signal of output_V"}}} {0x274 output_V_62 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 1983 to 1952 Data signal of output_V"}}} {0x278 output_V_63 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 2015 to 1984 Data signal of output_V"}}} {0x27c output_V_64 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 2047 to 2016 Data signal of output_V"}}} {0x280 output_V_ctrl R 0x0 "Control signal of output_V" {{0 1 output_V_ap_vld R 0 "Control signal output_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "a {base_address 128 range 128} b {base_address 256 range 128}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 4295081860 II x}
...
set enable_xo_gen 0
set kernel_files {/home/linux/Documents/DLA/source/sw/hls/BigInt/solution1/main.cpp}
if {$enable_xo_gen} {
