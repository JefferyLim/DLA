...
set Interfaces {
    s_axi_PERIPH_BUS {
        ...
        memories "a {base_address 128 range 128} b {base_address 256 range 128} c {base_address 512 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 147970 II x}
