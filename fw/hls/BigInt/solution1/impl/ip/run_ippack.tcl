...
set Interfaces {
    s_axi_PERIPH_BUS {
        ...
        memories "a {base_address 256 range 256} b {base_address 512 range 256} c {base_address 768 range 256} d {base_address 1024 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 50.000000 machine 64 combinational 0 latency undef II x}
...
set enable_xo_gen 0
set kernel_files {/home/linux/Documents/DLA/fw/hls/BigInt/solution1/main.c /home/linux/Documents/DLA/bigint/bigint.c}
if {$enable_xo_gen} {
