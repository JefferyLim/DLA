; ModuleID = '/home/jlim/Documents/school/DLA/source/sw/rsa_HLS/solution1/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define i512 @encrypt(i512 %key, i512 %exponent) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i512 0) nounwind, !map !27
  ...
  call void @llvm.dbg.value(metadata !{i512 %exponent}, i64 0, metadata !35), !dbg !36 ; [debug line = 6:38] [debug variable = exponent]
  %cyper = xor i512 %exponent, 100, !dbg !37      ; [#uses=1 type=i512] [debug line = 9:34]
  call void @llvm.dbg.value(metadata !{i512 %cyper}, i64 0, metadata !39), !dbg !37 ; [debug line = 9:34] [debug variable = cyper]
  %tmp = urem i512 %cyper, %key, !dbg !40         ; [#uses=1 type=i512] [debug line = 11:2]
  ret i512 %tmp, !dbg !40                         ; [debug line = 11:2]
}
...
!30 = metadata !{metadata !"return", metadata !31, metadata !"uint512", i32 0, i32 511}
!31 = metadata !{metadata !32}
!32 = metadata !{i32 0, i32 1, i32 0}
!33 = metadata !{i32 786689, metadata !5, metadata !"key", metadata !6, i32 16777222, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!34 = metadata !{i32 6, i32 25, metadata !5, null}
!35 = metadata !{i32 786689, metadata !5, metadata !"exponent", metadata !6, i32 33554438, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!36 = metadata !{i32 6, i32 38, metadata !5, null}
!37 = metadata !{i32 9, i32 34, metadata !38, null}
!38 = metadata !{i32 786443, metadata !5, i32 6, i32 47, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!39 = metadata !{i32 786688, metadata !38, metadata !"cyper", metadata !6, i32 9, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!40 = metadata !{i32 11, i32 2, metadata !38, null}
