...
CONFIG.FREQ_HZ {200000000} \
  ...
  # Create instance: bigint_math_0, and set properties
  set bigint_math_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:bigint_math:1.0 bigint_math_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins bigint_math_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bigint_math_0/s_axi_PERIPH_BUS/Reg] SEG_bigint_math_0_Reg
