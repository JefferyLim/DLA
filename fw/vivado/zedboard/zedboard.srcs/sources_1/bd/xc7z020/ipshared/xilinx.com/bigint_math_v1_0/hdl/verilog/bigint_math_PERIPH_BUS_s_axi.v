...
#(parameter
    ...
    input  wire [7:0]                    d_address0,
    input  wire                          d_ce0,
    output wire [7:0]                    d_q0
);
//------------------------Address Info-------------------
...
//------------------------Local signal-------------------
    ...
    reg                           int_c_write;
    reg  [1:0]                    int_c_shift;
    wire [5:0]                    int_d_address0;
    wire                          int_d_ce0;
    wire                          int_d_we0;
    wire [3:0]                    int_d_be0;
    wire [31:0]                   int_d_d0;
    wire [31:0]                   int_d_q0;
    wire [5:0]                    int_d_address1;
    wire                          int_d_ce1;
    wire                          int_d_we1;
    wire [3:0]                    int_d_be1;
    wire [31:0]                   int_d_d1;
...
assign RVALID  = (rstate == RDDATA) & !int_a_read & !int_b_read & !int_c_read & !int_d_read;
...
assign int_a_be0      = 1 << a_address0[1:0];
assign int_a_d0       = {4{a_d0}};
...
// d
assign int_d_address0 = d_address0 >> 2;
assign int_d_ce0      = d_ce0;
assign int_d_we0      = 1'b0;
assign int_d_be0      = 1'b0;
assign int_d_d0       = 1'b0;
assign d_q0           = int_d_q0 >> (int_d_shift * 8);
assign int_d_address1 = ar_hs? raddr[7:2] : waddr[7:2];
assign int_d_ce1      = ar_hs | (int_d_write & WVALID);
assign int_d_we1      = int_d_write & WVALID;
assign int_d_be1      = WSTRB;
