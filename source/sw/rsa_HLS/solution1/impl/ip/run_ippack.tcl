...
set Interfaces {
    s_axi_PERIPH_BUS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 key_V_1 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 31 to 0 Data signal of key_V"}}} {0x14 key_V_2 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 63 to 32 Data signal of key_V"}}} {0x18 key_V_3 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 95 to 64 Data signal of key_V"}}} {0x1c key_V_4 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 127 to 96 Data signal of key_V"}}} {0x20 key_V_5 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 159 to 128 Data signal of key_V"}}} {0x24 key_V_6 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 191 to 160 Data signal of key_V"}}} {0x28 key_V_7 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 223 to 192 Data signal of key_V"}}} {0x2c key_V_8 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 255 to 224 Data signal of key_V"}}} {0x30 key_V_9 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 287 to 256 Data signal of key_V"}}} {0x34 key_V_10 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 319 to 288 Data signal of key_V"}}} {0x38 key_V_11 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 351 to 320 Data signal of key_V"}}} {0x3c key_V_12 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 383 to 352 Data signal of key_V"}}} {0x40 key_V_13 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 415 to 384 Data signal of key_V"}}} {0x44 key_V_14 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 447 to 416 Data signal of key_V"}}} {0x48 key_V_15 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 479 to 448 Data signal of key_V"}}} {0x4c key_V_16 W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 511 to 480 Data signal of key_V"}}} {0x54 output_V_1 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 31 to 0 Data signal of output_V"}}} {0x58 output_V_2 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 63 to 32 Data signal of output_V"}}} {0x5c output_V_3 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 95 to 64 Data signal of output_V"}}} {0x60 output_V_4 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 127 to 96 Data signal of output_V"}}} {0x64 output_V_5 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 159 to 128 Data signal of output_V"}}} {0x68 output_V_6 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 191 to 160 Data signal of output_V"}}} {0x6c output_V_7 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 223 to 192 Data signal of output_V"}}} {0x70 output_V_8 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 255 to 224 Data signal of output_V"}}} {0x74 output_V_9 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 287 to 256 Data signal of output_V"}}} {0x78 output_V_10 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 319 to 288 Data signal of output_V"}}} {0x7c output_V_11 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 351 to 320 Data signal of output_V"}}} {0x80 output_V_12 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 383 to 352 Data signal of output_V"}}} {0x84 output_V_13 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 415 to 384 Data signal of output_V"}}} {0x88 output_V_14 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 447 to 416 Data signal of output_V"}}} {0x8c output_V_15 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 479 to 448 Data signal of output_V"}}} {0x90 output_V_16 R 0x0 "Data signal of output_V" {{0 32 output_V R 0 "Bit 511 to 480 Data signal of output_V"}}} {0x94 output_V_ctrl R 0x0 "Control signal of output_V" {{0 1 output_V_ap_vld R 0 "Control signal output_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/linux/Documents/DLA/source/sw/rsa_HLS/solution1/main.cpp}
if {$enable_xo_gen} {
